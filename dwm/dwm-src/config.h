...
static const char *dmenucmd[] = {"dmenu_wal", NULL};
...
static const char *volupcmd[] = {"wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@",
                                 "5%+", NULL};
static const char *bdowncmd[] = {"brightnessctl", "set", "5%-", NULL};
static const char *bupcmd[] = {"brightnessctl", "set", "+5%", NULL};
static const char *shotcmd[] = {
    "scrot", "/home/clara/screenshots/screenshot_%Y-%m-%d_%H-%M-%S.png", NULL};
static const char *shotselectcmd[] = {
    "scrot", "-s", "/home/clara/screenshots/screenshot_%Y-%m-%d_%H-%M-%S.png",
    NULL};
...
static const Key keys[] = {
    ...
    {ShiftMask, XK_Print, spawn, {.v = shotselectcmd}},
